...
export const JOURNAL_LISTING_POSTS = [
  /* ── Home-page journal cards (must match homeJournalData hrefs) ── */
  {
    ...
    excerpt: "Limited space doesn't mean limited style. See how to use mirrors, lighting, and smart furniture placement to make every inch feel intentional.",
  ...
  },
  {
    ...
    excerpt: "Picking a sofa is a big decision. We break down measurements, fabric types, and styles to help you find the perfect fit.",
  ...
  },
  {
    ...
    readMinutes: 6,
    title: "Mixing wood tones: A beginner's guide",
    excerpt: "Worried about matching your furniture? Here's how to confidently combine different wood finishes for a collected, intentional look.",
  ...
  },
  {
    ...
    categoryLabel: "Design Tips",
    readMinutes: 4,
    title: "Create a calmer bedroom in one weekend",
    excerpt: "Soft layers, the right lighting, and a few swaps can transform how your bedroom feels—without a full remodel.",
    image: "/bedroom-img.jpg",
  },
  /* ── Generated listing posts ── */
